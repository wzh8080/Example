package com.example.javafx.image.image2.ok3;
...
public class SelectableImageView extends Pane {
    ...
    private double initialX, initialY, initialWidth, initialHeight, dividerX;
    ...
    private void handleMouseReleased(MouseEvent event) {
        ...
        System.out.println("左半部分尺寸: width=" + (dividerX - selectionRect.getX()) + ", height=" + bounds.getHeight());
        System.out.println("右半部分尺寸: width=" + (bounds.getWidth() - (dividerX - selectionRect.getX())) + ", height=" + bounds.getHeight());
    }
    ...
    public double getRightSelectionWidth() {
        return selectionRect.getWidth() - (dividerX - selectionRect.getX());
    }
